	...
	public static void main(String[] args) {
       ...
       LocalDate ld = LocalDate.parse(dob,DateTimeFormatter.ofPattern("dd-MM-yyyy"));
			...
			if(ChronoUnit.DAYS.between(ld, lt) < 0 ){   
				...
				if(ld.getDayOfWeek()== (lt.getDayOfWeek()) && ld.getMonth() == lt.getMonth()) {				
			...
			System.out.println(ld.getMonth() == lt.getMonth());
			
			
			String strDate = ld.format(dob);
			
			System.out.println(ld.format(("dd-MM-yyy")));
